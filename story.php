...
<div class="row">
	<div class="col-12 story-area">
		<div class="row">
			...
			<div class="col-10">
				<h6 class="text-left"><a class="story-head-a" href="#">The title of story telling web</a></h6>
				<p>
				...
				<div class="comment">
					...
					<div>
						<!-- <form> -->
							...
							<div class="form-row">
								<div class="col-2">
									<button style="display: block;" class="story-a">Publish</button>
								</div>
								<div class="form-group col-2">
									<button id="closeComment" style="background-color: orange; display: block;" class="story-a">Close</button>
								</div>
							</div>
							<hr style="color: red">
						<!-- </form> -->
				...
				<button id="comment" class="story-a">Comment</button> <button id="viewComment" class="story-a">View Comment</button>
			</div>
		</div>
	</div>
